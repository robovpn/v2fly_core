...
var file_transport_internet_quic_config_proto_goTypes = []interface{}{
	(*Config)(nil),                  // 0: v2fly.core.transport.internet.quic.Config
	(*protocol.SecurityConfig)(nil), // 1: v2fly.core.common.protocol.SecurityConfig
	(*anypb.Any)(nil),               // 2: google.protobuf.Any
}
var file_transport_internet_quic_config_proto_depIdxs = []int32{
	1, // 0: v2fly.core.transport.internet.quic.Config.security:type_name -> v2fly.core.common.protocol.SecurityConfig
	2, // 1: v2fly.core.transport.internet.quic.Config.header:type_name -> google.protobuf.Any
