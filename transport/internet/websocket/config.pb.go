...
var file_transport_internet_websocket_config_proto_goTypes = []interface{}{
	(*Header)(nil), // 0: v2fly.core.transport.internet.websocket.Header
	(*Config)(nil), // 1: v2fly.core.transport.internet.websocket.Config
}
var file_transport_internet_websocket_config_proto_depIdxs = []int32{
	0, // 0: v2fly.core.transport.internet.websocket.Config.header:type_name -> v2fly.core.transport.internet.websocket.Header
