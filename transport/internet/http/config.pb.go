...
import (
	http "github.com/robovpn/github.com/robovpn/v2fly_core/transport/internet/headers/http"
...
var file_transport_internet_http_config_proto_goTypes = []interface{}{
	(*Config)(nil),      // 0: v2fly.core.transport.internet.http.Config
	(*http.Header)(nil), // 1: v2fly.core.transport.internet.headers.http.Header
}
var file_transport_internet_http_config_proto_depIdxs = []int32{
	1, // 0: v2fly.core.transport.internet.http.Config.header:type_name -> v2fly.core.transport.internet.headers.http.Header
