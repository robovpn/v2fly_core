...
// StartInstance starts a new v2fly instance with given serialized config.
// By default v2fly only support config in protobuf format, i.e., configFormat = "protobuf". Caller need to load other packages to add JSON support.
//
// v2fly:api:stable
...
// Dial provides an easy way for upstream caller to create net.Conn through v2fly.
// It dispatches the request to the given destination by the given v2fly instance.
...
func Dial(ctx context.Context, v *Instance, dest net.Destination) (net.Conn, error) {
	...
	if dispatcher == nil {
		return nil, newError("routing.Dispatcher is not registered in v2fly core")
	}
...
// DialUDP provides a way to exchange UDP packets through v2fly instance to remote servers.
