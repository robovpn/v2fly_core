...
var file_proxy_vless_outbound_config_proto_goTypes = []interface{}{
	(*Config)(nil),                  // 0: v2fly.core.proxy.vless.outbound.Config
	(*SimplifiedConfig)(nil),        // 1: v2fly.core.proxy.vless.outbound.SimplifiedConfig
...
var file_proxy_vless_outbound_config_proto_depIdxs = []int32{
	2, // 0: v2fly.core.proxy.vless.outbound.Config.vnext:type_name -> v2fly.core.common.protocol.ServerEndpoint
	3, // 1: v2fly.core.proxy.vless.outbound.SimplifiedConfig.address:type_name -> v2fly.core.common.net.IPOrDomain
