...
var file_proxy_vmess_outbound_config_proto_goTypes = []interface{}{
	(*Config)(nil),                  // 0: v2fly.core.proxy.vmess.outbound.Config
	(*SimplifiedConfig)(nil),        // 1: v2fly.core.proxy.vmess.outbound.SimplifiedConfig
	(*protocol.ServerEndpoint)(nil), // 2: v2fly.core.common.protocol.ServerEndpoint
	(*net.IPOrDomain)(nil),          // 3: v2fly.core.common.net.IPOrDomain
}
var file_proxy_vmess_outbound_config_proto_depIdxs = []int32{
	2, // 0: v2fly.core.proxy.vmess.outbound.Config.Receiver:type_name -> v2fly.core.common.protocol.ServerEndpoint
	3, // 1: v2fly.core.proxy.vmess.outbound.SimplifiedConfig.address:type_name -> v2fly.core.common.net.IPOrDomain
