...
var file_proxy_http_simplified_config_proto_goTypes = []interface{}{
	(*ServerConfig)(nil),   // 0: v2fly.core.proxy.http.simplified.ServerConfig
	(*ClientConfig)(nil),   // 1: v2fly.core.proxy.http.simplified.ClientConfig
	(*net.IPOrDomain)(nil), // 2: v2fly.core.common.net.IPOrDomain
}
var file_proxy_http_simplified_config_proto_depIdxs = []int32{
	2, // 0: v2fly.core.proxy.http.simplified.ClientConfig.address:type_name -> v2fly.core.common.net.IPOrDomain
